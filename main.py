...
@app.put("/system-users/{user_id}", response_model=schemas.SystemUserRead)
...
@app.delete("/system-users/{user_id}", status_code=204)
...
# --- Events Management (Admin + Operator) ---
...
# --- Directories Management (Admin + Operator) ---
